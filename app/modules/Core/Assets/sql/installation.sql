...
--
/*
INSERT IGNORE INTO `{prefix}groups` ( `name`, `description`, `is_default`, `type`, `undeletable`) VALUES
( 'Super', 'Super Administrator.', 0, 'admin', 1),
( 'Admin', 'Administrator.', 1, 'user', 0),
( 'User', 'Default user role.', 0, 'guest', 0);
( 'Guest', 'Guest role.', 0, 'guest', 0);
*/
-- Dumping data for table `access`
--
/*
INSERT IGNORE INTO `{prefix}access` (`object`, `action`, `role_id`, `value`) VALUES
...
INSERT IGNORE INTO `{prefix}pages` (`id`, `title`, `type`, `url`, `description`, `keywords`, `layout`, `controller`, `roles`, `view_count`) VALUES
...
INSERT IGNORE INTO `{prefix}widgets` (`id`, `module`, `name`, `description`, `is_paginated`, `is_acl_controlled`, `admin_form`, `enabled`) VALUES
...
INSERT INTO `{prefix}content` (`id`, `page_id`, `widget_id`, `widget_order`, `layout`, `params`) VALUES
...
INSERT IGNORE INTO `{prefix}languages` (`id`, `name`, `language`, `locale`, `icon`) VALUES
...
INSERT IGNORE INTO `{prefix}menus` (`id`, `name`) VALUES
(1, 'Default menu');
...
INSERT IGNORE INTO `{prefix}menu_items` (`id`, `title`, `menu_id`, `parent_id`, `page_id`, `url`, `onclick`, `target`, `tooltip`, `tooltip_position`, `icon`, `icon_position`, `item_order`, `languages`, `roles`, `is_enabled`) VALUES
...
INSERT IGNORE INTO `{prefix}packages` (`id`, `name`, `type`, `title`, `description`, `version`, `author`, `website`, `enabled`, `is_system`) VALUES
