...
<head>
    ...
    <script type="text/javascript">
        var deleteItem = function (id) {
            if (confirm('<?php echo $this->i18n->query('Are you really want to delete this page?'); ?>')) {
                window.location.href = '<?php echo $this->url->get(array('for' => 'admin-pages-delete')); ?>' + id;
            }
        }
    </script>
...
<body data-base-url="<?php echo $this->url->get(); ?>" data-debug="<?php echo $this->config->application->debug; ?>">
            ...
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="#" class="navbar-brand">
                        <small>
                            <img src="<?php echo $this->url->get('themes/default/images/logo.png'); ?>" alt="" />
                        </small>
                    </a>
                </div>
                <!-- /Navbar Barnd -->
                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo $this->url->get('themes/default/images/avatars/divyia.png'); ?>" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo $this->url->get('themes/default/images/avatars/bing.png'); ?>" class="message-avatar" alt="Microsoft Bing">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Bing.com
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo $this->url->get('themes/default/images/avatars/adam-jansen.png'); ?>" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Nicolas
                                                </span>
                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                    <div class="avatar" title="View your public profile">
                                        <img src="<?php echo $this->url->get('themes/default/images/avatars/adam-jansen.png'); ?>">
                                    </div>
                                    <section>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li>
                                        <div class="avatar-area">
                                            <img src="<?php echo $this->url->get('themes/default/images/avatars/adam-jansen.png'); ?>" class="avatar">
    ...
    <div class="span12">
        <div class="row-fluid">
            <h2><?php echo $this->i18n->query('Pages'); ?> (<?php echo $grid->getTotalCount(); ?>)</h2>
