...
<html>
<head>
    <title><?php echo $this->i18n->query('Roles'); ?></title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        var deleteItem = function (id) {
            if (confirm('<?php echo $this->i18n->query('Are you really want to delete this role?'); ?>')) {
                window.location.href = '<?php echo $this->url->get(array('for' => 'admin-roles-delete')); ?>' + id;
            }
        }
    </script>
...
<div class="content">
    ...
    <div class="span12">
        <div class="row-fluid">
            <h2><?php echo $this->i18n->query('Roles'); ?> (<?php echo $grid->getTotalCount(); ?>)</h2>
