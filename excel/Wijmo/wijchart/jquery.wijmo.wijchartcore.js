    ...
    */
    (function (chart) {
        ...
        var wijchartcore = (function (_super) {
            ...
            */
            ...
            wijchartcore.prototype._getLegendbasicInfo = function () {
                var self = this, o = this.options, legend = o.legend, legendInfo, chartsSeries = o.seriesList, chartsSeriesStyles = o.seriesStyles, legendOptions = {
            ...
            wijchartcore.prototype._legendClickFunc = function (data) {
                var seriesIdx = data.seriesIdx, fields = this.chartElement.data("fields"), seriesEles = this.seriesEles, seriesEle;
                ...
                if (!data.visible) {
                    this._showSerieEles(seriesEles[seriesIdx]);
                } else {
                    this._hideSerieEles(seriesEles[seriesIdx]);
                }
            };
            ...
            wijchartcore.prototype._getLegendSeriesInfoList = function () {
                var self = this, o = self.options, legendInfo, chartsSeries = o.seriesList, chartsSeriesStyles = o.seriesStyles, seriesStyle, legendInfoList = [];
                $.each(chartsSeries, function (idx, series) {
                    seriesStyle = self._getLegendStyle(chartsSeriesStyles[idx]);

                    if (series.legendEntry !== false) {
                        if (series.isTrendline) {
                            legendInfo = self._getTrendLineLegendInfoFromSeries(idx, series, seriesStyle);
                        } else {
                            legendInfo = self._getLegendInfoFromSeries(idx, series, seriesStyle);
                        }
                        if (legendInfo) {
        ...
        */
        var Title = (function (_super) {
            ...
            Title.prototype._paintTitle = function () {
                ...
                if (text && text.length > 0 && visible) {
                    this.titleTextEle = ChartRendererUtil._text(this.canvas, 0, 0, text);
        ...
        /** @ignore */
        // ** LegendOptions **
        var LegendRendererOptions = (function () {
        ...
        var Legend = (function (_super) {
            ...
            Legend.prototype._paintTitle = function () {
                ...
                if (titleText && titleText.length) {
                    titleEle = ChartRendererUtil._text(this.canvas, 0, 0, titleText);
            ...
            Legend.prototype._paintLabelSet = function (legendInfo) {
                ...
                if (o.labelWidth) {
                    ...
                    labelEle = ChartRendererUtil._text(self.canvas, 0, 0, legendInfo.label);
        ...
        /** @ignore */
        // ** AxisOptions **
        var AxisRendererOptions = (function () {
        ...
        var Axis = (function (_super) {
            ...
            Axis.prototype._paintLabel = function (x, y, text) {
                ...
                if (text !== null && textVisible) {
                    if (labelWidth) {
                        ...
                        txt = ChartRendererUtil._text(this.canvas, x, y, text.toString());
                        $.wijraphael.addClass($(txt.node), o.labelCSS);
                        txt.attr(textStyle);
                    }
                }
            ...
            Axis.prototype._paintAxisTitle = function () {
                ...
                axisTitleElement = ChartRendererUtil._text(this.canvas, 0, 0, titleText.toString());
