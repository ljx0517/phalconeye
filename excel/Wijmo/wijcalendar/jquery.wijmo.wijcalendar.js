    ...
    (function (_calendar) {
        ...
        var wijcalendar = (function (_super) {
            ...
            */
            ...
            wijcalendar.prototype._updateMyGrid = function (duration) {
                if (typeof duration === "undefined") { duration = 0; }
                this._refreshTitle();
                this.element.width(this.element.width()).height(this.element.height());

                var wijCSS = this.options.wijCSS, curTable = this.element.find('.' + wijCSS.datepickerCalendar), wrapper, container, nextTable, w = curTable.outerWidth(), h = curTable.outerHeight(), selIndex, row, col, toWidth, toHeight, toBounds, calendar = this, aniDur = duration || this.options.duration || 500;
