/**
* 
* Please add references of jQuery.d.ts and Raphael.d.ts manually
* 
*/
...
interface JQuery {
    ...
    /** Exports the chart in a graphic format. 
      ...
      * @remarks
      * Default exported file type is png, possible types are: jpg, png, gif, bmp, tiff, pfd.
      * @example
      * $("#chartcore").wijchartcore("exportChart", "chart", "png");
      */
    wijchartcore(methodName: "exportChart", fileName: any, type?: any, serviceUrl?: any, pdfSettings?: any) ;
    ...
    /** Get chartLabels option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "chartLabels") ;
    /** Set chartLabels option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "chartLabels", chartLabelsValue ): JQuery;
    ...
    /** Get adjustMinValue option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "adjustMinValue") ;
    /** Set adjustMinValue option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "adjustMinValue", adjustMinValueValue ): JQuery;
    ...
    /** Get canvas option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "canvas") ;
    /** Set canvas option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "canvas", canvasValue ): JQuery;
    
    /** Get widget option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "widget") ;
    /** Set widget option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "widget", widgetValue ): JQuery;
    
    /** Get bounds option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "bounds") ;
    /** Set bounds option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "bounds", boundsValue ): JQuery;
    
    /** Get widgetName option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "widgetName") ;
    /** Set widgetName option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "widgetName", widgetNameValue ): JQuery;
    
    /** Get tooltip option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "tooltip") ;
    /** Set tooltip option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "tooltip", tooltipValue ): JQuery;
    
    /** Get aniPathsAttr option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "aniPathsAttr") ;
    /** Set aniPathsAttr option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "aniPathsAttr", aniPathsAttrValue ): JQuery;
    
    /** Get extremeValue option of wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "extremeValue") ;
    /** Set extremeValue option to wijchartcore widget */
    wijchartcore(methodName: "option", optionName: "extremeValue", extremeValueValue ): JQuery;
...
interface JQuery {
    ...
    /** Exports the grid to a specified format. 
      ...
      */
    wijgrid(methodName: "exportGrid", fileName: any, type: any, settings?: any, serviceUrl?: any) ;
    ...
    /** Get wijCSS option of wijgrid widget */
    wijgrid(methodName: "option", optionName: "wijCSS") ;
    /** Set wijCSS option to wijgrid widget */
    wijgrid(methodName: "option", optionName: "wijCSS", wijCSSValue ): JQuery;
...
interface JQuery {
    ...
    /** Get afterSlide option of wijinputdate widget */
    wijinputdate(methodName: "option", optionName: "afterSlide") ;
    /** Set afterSlide option to wijinputdate widget */
    wijinputdate(methodName: "option", optionName: "afterSlide", afterSlideValue ): JQuery;
...
interface JQuery {
    ...
    /** Get availableWidth option of wijpiechart widget */
    wijpiechart(methodName: "option", optionName: "availableWidth") ;
    /** Set availableWidth option to wijpiechart widget */
    wijpiechart(methodName: "option", optionName: "availableWidth", availableWidthValue ): JQuery;
    
    /** Get availableHeight option of wijpiechart widget */
    wijpiechart(methodName: "option", optionName: "availableHeight") ;
    /** Set availableHeight option to wijpiechart widget */
    wijpiechart(methodName: "option", optionName: "availableHeight", availableHeightValue ): JQuery;
