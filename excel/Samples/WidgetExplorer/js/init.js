...
function parseUrl(urlString) {
	var paneId, widgetName, branch, folder,
		urlArray, urlObj, widgetArray, documentation;
	...
	if (widgetArray[1]) {
		...
		branch = ControlList[urlObj.widgetName].branch;
		folder = FullFoldEnum[branch];
		urlObj.widgetFoldName = folder;
		urlObj.documentation = ControlList[urlObj.widgetName].documentation;
	}
...
function initTabSelection() {
	$("#ctl00_WidgetTabs").find(".ui-tabs-nav li.ui-state-default >a").each(function () {
...
var FullFoldEnum = {
    complete:"Wijmo-Complete/development-bundle/samples",
    open: "Wijmo-Open/development-bundle/samples"
}